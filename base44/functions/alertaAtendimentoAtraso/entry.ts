...
Deno.serve(async (req) => {
  ...
  // Buscar atendimentos e usuários em paralelo
  ...
  // - data_agendada entre 2h atrás e 15min atrás (janela ativa)
  const atrasados = todosAtendimentos.filter(a => {
    ...
    return d <= quinzeMinAtras && d >= duasHorasAtras;
  });
