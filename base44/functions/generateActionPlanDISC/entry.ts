...
- Pontuações: D=${diagnostic.profile_scores.executor_d}% I=${diagnostic.profile_scores.comunicador_i}% S=${diagnostic.profile_scores.planejador_s}% C=${diagnostic.profile_scores.analista_c}%
