...
Deno.serve(async (req) => {
    try {
        ...
        if (scope === 'workshop') {
            ...
            promptContext = `
                CONTEXTO GLOBAL (REDE DE OFICINAS):
                Total Oficinas Ativas: ${activeWorkshops}
                Amostra de Performance Recente: Baseado nos top 50 registros globais.
                Objetivo: Criar um desafio que engaje toda a rede ou grupos específicos.
            `;
        }
        ...
        const prompt = `
            ...
            TAREFA:
            Analise os dados acima e sugira UM (1) desafio estratégico para melhorar os resultados.
            O desafio deve ser motivador, claro e focado em um KPI específico (produtividade, faturamento, qualidade, etc.).
            
            Se for nível OFICINA: Foque nas áreas com menor performance ou maior oportunidade.
            Se for nível GLOBAL: Foque em um tema que possa ser aplicado a várias oficinas.
            ...
            RETORNE APENAS UM JSON VÁLIDO COM A SEGUINTE ESTRUTURA (sem markdown, sem explicações):
            {
                ...
                "goal_value": number (valor meta sugerido, ex: 10000 ou 100),
                "reward_xp": number (ex: 500),
