...
export default function DesesosCliente() {
  ...
  const { data: desejos = [], isLoading } = useQuery({
    queryKey: ["client-intelligence", workshop?.id, "desejo"],
    queryFn: () =>
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Desejos Estratégicos</h1>
          <p className="text-gray-600 mt-2">Mapeie aspirações e objetivos estratégicos</p>
        </div>
      ...
      {showForm && (
        <div className="bg-white p-6 rounded-lg border border-gray-200 mb-8">
          <h2 className="text-xl font-semibold mb-6">
            {editingItem ? "Editar Desejo" : "Registrar Novo Desejo"}
          </h2>
