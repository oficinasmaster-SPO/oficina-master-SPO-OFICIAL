          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full px-4">
              <Button 
                ...
                size="lg" 
                className="w-full sm:w-auto bg-white text-blue-700 hover:bg-blue-50 text-base md:text-lg px-8 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all"
              >
                <Rocket className="mr-2 h-5 w-5 flex-shrink-0" />
                Criar Conta Grátis
              </Button>
              <Button 
                onClick={handleLogin}
                size="lg" 
                variant="outline"
                className="w-full sm:w-auto bg-transparent border-2 border-white text-white hover:bg-white/10 text-base md:text-lg px-8 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all"
              >
