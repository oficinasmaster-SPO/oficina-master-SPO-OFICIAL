...
export default function DescricoesCargo() {
  ...
  const getWorkshopName = (workshopId) => {
    ...
    return workshop?.name || "Ṇo informado";
  };
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Gerencie as descri̵̤es de cargo da sua oficina
            </p>
          </div>
          <Button
          ...
          <Card className="shadow-lg">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Crie sua primeira descri̤̣o de cargo para come̤ar
              </p>
              <Button
                onClick={() => navigate(createPageUrl("CriarDescricaoCargo"))}
                className="bg-purple-600 hover:bg-purple-700"
