    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600">Oficina nÃ£o encontrada</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">AnÃ¡lises Inteligentes de RH</h1>
          <p className="text-gray-600">Insights gerados por IA para decisÃµes estratÃ©gicas</p>
        </div>
        ...
        <Tabs defaultValue="clima" className="space-y-6">
          <TabsList className="grid grid-cols-2 bg-white shadow-md">
            ...
            <TabsTrigger value="treinamentos">
              ...
              RecomendaÃ§Ã£o de Treinamentos
            </TabsTrigger>
          </TabsList>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {employees.map(emp => (
          ...
          >
            ...
            <div className="text-xs text-gray-500 mt-1">{emp.area || 'Ãrea nÃ£o definida'}</div>
          </button>
        ))}
      </div>
    </div>
