...
export default function AprovarColaboradores() {
  ...
  // MutaÃ§Ã£o para rejeitar acesso
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-600">
              Todos os colaboradores foram aprovados ou ainda nÃ£o se cadastraram.
            </p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <div className="text-right text-sm text-gray-500">
                    ...
                    <p className="font-medium text-gray-700">
                      {employee.first_login_at 
                        ? format(new Date(employee.first_login_at), "dd/MM/yyyy 'Ã s' HH:mm", { locale: ptBR })
                        : format(new Date(employee.created_date), "dd/MM/yyyy 'Ã s' HH:mm", { locale: ptBR })
                      }
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500">Ãrea</p>
                ...
                {/* Alerta de ConfiguraÃ§Ã£o */}
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex gap-3">
                    <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                    <div className="text-sm text-blue-800">
                      <p className="font-semibold mb-1">ConfiguraÃ§Ã£o NecessÃ¡ria</p>
                      <p>
                        Selecione um perfil de acesso para definir as permissÃµes que este colaborador terÃ¡ no sistema.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    O perfil define quais mÃ³dulos e funcionalidades o colaborador poderÃ¡ acessar
                  </p>
                </div>
