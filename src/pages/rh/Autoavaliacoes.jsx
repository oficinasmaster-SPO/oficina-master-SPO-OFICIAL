  ...
  const assessments = [
    {
      ...
      description: "Controle, ticket mÃ©dio, TCMP2, R70/I30, comissÃ£o e metas",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "LigaÃ§Ãµes, agendamento, no show, pÃ³s-venda e indicaÃ§Ãµes",
      icon: Phone,
    ...
    },
    {
      ...
      description: "AnÃºncios, Google Ads, Meta Ads, redes sociais e conteÃºdo",
      icon: Megaphone,
    ...
    },
    {
      ...
      description: "Controle, compras, geraÃ§Ã£o de caixa, despesas e orÃ§amento",
      icon: DollarSign,
    ...
    {
      title: "AvaliaÃ§Ã£o Empresarial",
      description: "GestÃ£o, inovaÃ§Ã£o, lucros, visÃ£o, clima e produtividade",
      icon: Building2,
    ...
    {
      title: "AvaliaÃ§Ã£o MA3 - Ãreas",
      description: "Vendas, comercial, financeiro, tÃ©cnico, estoque e RH",
      icon: LayoutGrid,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">
            Mapa da AutoavaliaÃ§Ã£o da Empresa
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Avalie processos semanalmente, identifique gargalos e acompanhe a evoluÃ§Ã£o mensal.
          </p>
        </div>
                  ...
                  <CardContent>
                    {isLocked ? (
                        <div className="text-sm text-amber-600 bg-amber-50 p-3 rounded-lg border border-amber-100 flex items-start gap-2">
                            ...
                            <span>
                                DisponÃ­vel em {status.daysRemaining} dia(s). 
                                <br/>
                                <span className="text-xs opacity-80">AvaliaÃ§Ã£o permitida apenas uma vez por semana.</span>
                            </span>
                        </div>
                    ) : (
                        <div className="text-sm text-green-600 bg-green-50 p-3 rounded-lg border border-green-100 flex items-center gap-2">
                            <CalendarClock className="w-4 h-4" />
                            <span>DisponÃ­vel para avaliaÃ§Ã£o semanal</span>
                        </div>
                    )}
                  </CardContent>
                  <CardFooter>
                    ...
                    >
                      {isLocked ? 'Aguardando Prazo' : 'Iniciar AvaliaÃ§Ã£o'}
