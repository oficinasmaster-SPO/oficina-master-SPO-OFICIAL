...
export default function DRETCMP2() {
  ...
  const loadData = async () => {
    try {
      ...
      // Verificar se hÃ¡ workshop_id na URL (admin visualizando)
      ...
      if (adminWorkshopId && currentUser.role === 'admin') {
        // Admin visualizando oficina especÃ­fica
  ...
  // Sincronizar dados: consolidar registros diÃ¡rios â†’ DRE â†’ metas
  useEffect(() => {
    if (workshop && viewMode === 'month') {
      const syncData = async () => {
        // 1. Consolidar dados diÃ¡rios para o DRE
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      // Marcar mÃ³dulo DRE como concluÃ­do
  ...
  const calculateDRE = (data) => {
    ...
    // R70/I30 = (Faturamento Total - Custo PeÃ§as Aplicadas - PeÃ§as Estoque) / Faturamento Total
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">DRE & TCMPÂ²</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-2 print:hidden">
              <Select value={viewMode} onValueChange={setViewMode}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="average">MÃ©dia Geral</SelectItem>
                </SelectContent>
              </Select>
                          ...
                          <span className="flex justify-between w-full gap-4">
                            ...
                            {tcmp2Value && (
                              <span className="text-gray-500 font-mono text-xs flex items-center">
                                TCMPÂ²: {formatCurrency(tcmp2Value)}
                              </span>
                            )}
                          </span>
                        </SelectItem>
            ...
            <div className="flex justify-between items-center">
              <div>
                <CardTitle className="flex items-center gap-2">
                  ...
                  EvoluÃ§Ã£o do TCMPÂ² (Valor Hora)
                </CardTitle>
                <CardDescription>
                  Acompanhe a variaÃ§Ã£o do valor da hora tÃ©cnica ao longo dos meses.
                </CardDescription>
              </div>
              <div className="text-right">
                 <p className="text-sm text-gray-500">MÃ©dia Geral</p>
            ...
            <div className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  />
                  <Legend />
                  <ReferenceLine y={averageTcmp2} label="MÃ©dia" stroke="red" strokeDasharray="3 3" />
                  <Line 
                    type="monotone" 
                    dataKey="tcmp2" 
                    name="TCMPÂ²" 
        ...
        <Tabs defaultValue="receitas" className="space-y-6">
          <TabsList className="bg-white shadow-md">
            <TabsTrigger value="receitas">ðŸ’° Receitas</TabsTrigger>
            <TabsTrigger value="custos_tcmp2">âš™ï¸ Custos TCMPÂ² (Entram)</TabsTrigger>
            <TabsTrigger value="custos_nao_tcmp2">ðŸš« Custos NÃƒO TCMPÂ²</TabsTrigger>
            <TabsTrigger value="pecas">ðŸ“¦ PeÃ§as</TabsTrigger>
            <TabsTrigger value="resumo">ðŸ“Š Resumo DRE</TabsTrigger>
          </TabsList>
           ...
           <TabsContent value="receitas">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Informe o faturamento do mÃªs</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <Label>TÃ©cnicos Produtivos</Label>
                    <Input
                      type="number"
                      min="1"
                  ...
                  <div>
                    <Label>Horas DisponÃ­veis/MÃªs (por tÃ©cnico)</Label>
                    <Input
                      type="number"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <Label>Faturamento PeÃ§as Aplicadas (R$)</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Faturamento ServiÃ§os (R$)</Label>
                    <Input
                      type="number"
          ...
          <TabsContent value="custos_tcmp2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Estes custos sÃ£o usados para calcular o valor hora ideal (TCMPÂ²)
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div>
                    <Label>Operacionais (Aluguel, Energia, Ãgua, Tel)</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Pessoas (SalÃ¡rios, Encargos, BenefÃ­cios)</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>PrÃ³-labore dos SÃ³cios</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>ManutenÃ§Ã£o (Predial e Equipamentos)</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>ServiÃ§os Terceirizados</Label>
                    <Input
                      type="number"
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-700">Total Custos TCMPÂ²</p>
          ...
          <TabsContent value="custos_nao_tcmp2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Estes custos sÃ£o financeiros/investimentos e nÃ£o devem compor o valor hora
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    <Label>Boletos de PeÃ§as (Estoque)</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Compra de Terreno/ImÃ³vel</Label>
                    <Input
                      type="number"
                ...
                <div className="mt-4 p-4 bg-orange-50 rounded-lg">
                  <p className="text-sm text-orange-700">Total Custos NÃƒO TCMPÂ²</p>
          ...
          <TabsContent value="pecas">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Separar peÃ§as aplicadas de peÃ§as compradas para estoque (afeta R70/I30)
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label>Custo das PeÃ§as APLICADAS no MÃªs (R$)</Label>
                    <Input
                      type="number"
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      PeÃ§as que foram efetivamente usadas em serviÃ§os
                    </p>
                  </div>
                  <div>
                    <Label>PeÃ§as Compradas para ESTOQUE (R$)</Label>
                    <Input
                      type="number"
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      PeÃ§as compradas mas ainda em estoque
                    </p>
                  </div>
                </div>

                <div className="mt-6 p-4 bg-purple-50 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">CÃ¡lculo R70/I30</h4>
                  <p className="text-sm text-purple-700 mb-2">
                    R70/I30 = (Faturamento - PeÃ§as Aplicadas - PeÃ§as Estoque) / Faturamento
                  </p>
          ...
          <TabsContent value="resumo">
            <Card>
              <CardHeader>
                <CardTitle>ðŸ“Š DRE - Demonstrativo de Resultados</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2">CUSTOS TCMPÂ² (Operacionais)</h4>
                    <div className="space-y-1 text-sm">
                      ...
                      <div className="flex justify-between"><span>PrÃ³-labore</span><span>{formatCurrency(formData.costs_tcmp2.prolabore)}</span></div>
                      <div className="flex justify-between"><span>Marketing</span><span>{formatCurrency(formData.costs_tcmp2.marketing)}</span></div>
                      <div className="flex justify-between"><span>ManutenÃ§Ã£o</span><span>{formatCurrency(formData.costs_tcmp2.maintenance)}</span></div>
                  ...
                  <div className="p-4 bg-orange-50 rounded-lg">
                    <h4 className="font-semibold text-orange-900 mb-2">CUSTOS NÃƒO TCMPÂ² (Financeiros)</h4>
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between font-bold border-t pt-1 mt-2">
                        <span>TOTAL CUSTOS NÃƒO TCMPÂ²</span>
                  ...
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <h4 className="font-semibold text-purple-900 mb-2">CUSTOS COM PEÃ‡AS</h4>
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        <span>PeÃ§as Aplicadas</span>
                  ...
                  <div className="p-4 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg border-2 border-green-300">
                    <h4 className="font-semibold text-green-900 mb-2">TCMPÂ² - VALOR HORA IDEAL</h4>
                    <p className="text-4xl font-bold text-green-700">{formatCurrency(calculated.tcmp2_value)}</p>
                    <p className="text-sm text-green-600 mt-1">
                      Baseado em {formData.productive_technicians} tÃ©cnico(s) Ã— {formData.monthly_hours}h = {formData.productive_technicians * formData.monthly_hours}h totais
                    </p>
                  </div>
                </div>
              </CardContent>
