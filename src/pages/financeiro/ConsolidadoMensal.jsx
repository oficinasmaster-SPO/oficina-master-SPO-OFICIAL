      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p className="text-gray-600">AnÃ¡lise comparativa das avaliaÃ§Ãµes semanais</p>
            </div>
        ...
        {!monthlyData || monthlyData.totalCount === 0 ? (
            <Card className="bg-white/50 border-dashed">
                <CardContent className="py-12 text-center text-gray-500">
                    ...
                    <p className="text-lg">Nenhuma avaliaÃ§Ã£o encontrada para este mÃªs.</p>
                    <p className="text-sm">Realize as autoavaliaÃ§Ãµes semanais para gerar o relatÃ³rio.</p>
                </CardContent>
            </Card>
        ) : (
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-500">AvaliaÃ§Ãµes Realizadas</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-3xl font-bold text-blue-600">{monthlyData.totalCount}</div>
                            <p className="text-xs text-gray-500 mt-1">Neste mÃªs</p>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-500">Melhor Ãrea</CardTitle>
                        </CardHeader>
                        <CardContent>
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                                MÃ©dia: {monthlyData.averages[0]?.average.toFixed(1) || '0.0'}
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-500">Ãrea de AtenÃ§Ã£o</CardTitle>
                        </CardHeader>
                        <CardContent>
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                                MÃ©dia: {monthlyData.averages[monthlyData.averages.length - 1]?.average.toFixed(1) || '0.0'}
                            </p>
                        </CardContent>
                    </Card>
                </div>
                ...
                <Card className="shadow-lg">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            EvoluÃ§Ã£o Semanal por Ãrea
                        </CardTitle>
                        <CardDescription>
                            Comparativo das notas ao longo das semanas do mÃªs
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="shadow-lg">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            MÃ©dia Geral do MÃªs
                        </CardTitle>
                        <CardDescription>
                            Desempenho consolidado por Ã¡rea
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={monthlyData.averages} layout="vertical">
                                    ...
                                    <Tooltip 
                                        ...
                                        contentStyle={{ borderRadius: '8px', border: 'none', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
                                    />
                                    <Bar dataKey="average" name="MÃ©dia" radius={[0, 4, 4, 0]}>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                    <h3 className="text-lg font-semibold text-blue-900 mb-2">ðŸ’¡ AnÃ¡lise de PrÃ³ximos Passos</h3>
                    <p className="text-blue-800 leading-relaxed">
                        Com base nos resultados das Ãºltimas 4 semanas, utilize este relatÃ³rio para planejar o prÃ³ximo mÃªs.
                        Foque nas Ã¡reas com menor desempenho ({monthlyData.averages[monthlyData.averages.length - 1]?.type}) e mantenha a constÃ¢ncia nas Ã¡reas fortes.
                        A evoluÃ§Ã£o semanal mostra se as aÃ§Ãµes tomadas durante o mÃªs surtiram efeito imediato.
                    </p>
                </div>
            </div>
        )}
