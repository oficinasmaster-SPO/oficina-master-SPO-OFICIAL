...
export default function MapaChecklists() {
  ...
  const { data: checklists = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Buscar checklists padrÃµes do sistema
      const defaultQuery = {
        is_default: true,
        type: selectedType,
      };
      ...
      // Combinar e ordenar (oficina primeiro, depois padrÃµes)
      const combined = [
    ...
    <div className="space-y-6 p-6 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Gerencie checklists para cada tipo de inteligÃªncia do cliente
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          <Select value={selectedArea} onValueChange={setSelectedArea}>
            ...
            <SelectContent>
              <SelectItem value={null}>Todas as Ã¡reas</SelectItem>
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      <th className="text-left p-4 text-sm font-semibold text-gray-700">TÃ­tulo</th>
                      <th className="text-left p-4 text-sm font-semibold text-gray-700">Ãrea</th>
                      ...
                      <th className="text-center p-4 text-sm font-semibold text-gray-700">AÃ§Ãµes</th>
                    </tr>
                  </thead>
                  <tbody>
