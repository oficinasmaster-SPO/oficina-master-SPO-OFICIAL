...
export default function DuvidasCliente() {
  ...
  const { data: duvidas = [], isLoading } = useQuery({
    queryKey: ["client-intelligence", workshop?.id, "duvida"],
    queryFn: () =>
    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Registre d̼vidas e falta de clareza identificadas</p>
        </div>
      ...
      {showForm && (
        <div className="bg-white p-6 rounded-lg border border-gray-200 mb-8">
          <h2 className="text-xl font-semibold mb-6">
            {editingItem ? "Editar D̼vida" : "Registrar Nova D̼vida"}
          </h2>
