...
export default function AutoavaliacaoMA3() {
  ...
  const criteria = assessmentCriteria.ma3;
  ...
  const loadData = async () => {
    try {
      ...
      base44.auth.redirectToLogin(createPageUrl("AutoavaliacaoMA3"));
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center">
            <Button
              type="submit"
              disabled={submitting}
              className="bg-cyan-600 hover:bg-cyan-700 text-lg px-12 py-6"
            >
              {submitting ? (
                <>
