...
export default function DesdobramentoMeta() {
  ...
  const loadData = async () => {
    try {
      ...
      // Strict filtering by workshop_id to prevent data leak
  ...
  const calculateRow = (emp, growthPct) => {
    ...
    // Bonus Calculation based on user rules
    // Rule: "comissão por peça produzida ou a cada x faturamento bonus x"
    // Implementation: Fixed bonus % on target revenue for simplicity in this view, can be customized
    // Using a base 0.5% of target revenue as default bonus pool for hitting target
    const bonus = target_revenue * 0.005; 
