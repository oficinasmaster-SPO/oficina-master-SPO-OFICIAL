...
export default function ManualProcessos() {
  ...
  const { data: manualData, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Buscar processos baseado na escolha do usuÃ¡rio
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">DocumentaÃ§Ã£o completa da sua empresa</p>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 max-w-2xl">
              Este manual reÃºne automaticamente todos os processos, procedimentos, cultura organizacional, 
              descriÃ§Ãµes de cargo e indicadores da sua empresa em um documento estruturado e profissional.
            </p>
          </div>
          ...
          {(isLoading || isRefetching) ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full mt-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600">DescriÃ§Ãµes de Cargo</p>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
                <p className="text-3xl font-bold text-orange-600">
                  {manualData?.areas?.filter(a => a.category === 'geral').length || 0}
                </p>
                <p className="text-sm text-gray-600">Ãreas Gerais</p>
              </div>
            </div>
          )}
          ...
          {!isLoading && !manualData?.cultura && (
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg flex items-start gap-3 w-full">
              ...
              <div className="text-left">
                <p className="font-semibold text-yellow-900">InformaÃ§Ã£o de Cultura nÃ£o encontrada</p>
                <p className="text-sm text-yellow-700 mt-1">
                  Configure MissÃ£o, VisÃ£o e Valores em <strong>Cultura â†’ MissÃ£o, VisÃ£o e Valores</strong> 
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-0.5">
                    Adiciona processos padrÃ£o da consultoria ao manual
                  </p>
                </div>
              </div>
              <Switch
          ...
          <div className="bg-gray-50 p-4 rounded-lg w-full mt-6">
            <p className="text-xs text-gray-600 text-left">
              <strong>O manual inclui:</strong> ApresentaÃ§Ã£o institucional, estrutura organizacional, 
              processos por Ã¡rea, funÃ§Ãµes e cargos, padrÃµes operacionais, indicadores e metas, 
              regras gerais, integraÃ§Ã£o de colaboradores e controle de versÃ£o.
            </p>
          </div>
        </div>
      </Card>
