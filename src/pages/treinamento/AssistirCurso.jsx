...
export default function AssistirCurso() {
  ...
  if (!course) {
    return (
      <div className="max-w-4xl mx-auto p-6 text-center">
        <p className="text-gray-600">Curso nÃ£o encontrado</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      {/* Lista de MÃ³dulos e Aulas */}
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-gray-900">ConteÃºdo do Curso</h2>

        {modules.length === 0 ? (
          <Card>
            <CardContent className="p-8 text-center">
              <p className="text-gray-600">Este curso ainda nÃ£o possui mÃ³dulos configurados</p>
            </CardContent>
          </Card>
        ) : (
          modules.map((module) => {
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge variant="outline">
                      {completedCount} / {moduleLessons.length} concluÃ­das
                    </Badge>
                  </div>

                  <div className="space-y-2">
                    {moduleLessons.length === 0 ? (
                      <p className="text-sm text-gray-500">Nenhuma aula disponÃ­vel</p>
                    ) : (
