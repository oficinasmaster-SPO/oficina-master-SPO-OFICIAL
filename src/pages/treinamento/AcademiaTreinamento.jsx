...
export default function AcademiaTreinamento() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log("ðŸ“š Cursos encontrados:", allCourses.length);
      ...
      console.error("âŒ Erro ao carregar academia:", error);
  ...
  // Se nÃ£o houver nenhum curso, mostrar tela vazia
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center text-white space-y-4 px-4">
          <h2 className="text-3xl font-bold">ðŸŽ“ Academia de Treinamento</h2>
          <p className="text-gray-400 text-lg">
            Nenhum curso disponÃ­vel no momento.
          </p>
          <p className="text-gray-500">
            Os cursos aparecerÃ£o aqui assim que forem criados.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative -mt-32 space-y-12 pb-16">
        ...
        {trendingWeek.length > 0 && (
          <CourseRow
            title="ðŸ”¥ TendÃªncias da Semana"
        ...
        {Object.entries(byCategory).map(([category, courses]) => {
          ...
          const categoryLabels = {
            vendas: "ðŸ’° Vendas & NegociaÃ§Ã£o",
            tecnico: "ðŸ”§ TÃ©cnico & Operacional",
            gestao: "ðŸ“Š GestÃ£o & LideranÃ§a",
            comercial: "ðŸ“ˆ Comercial & Marketing",
            marketing: "ðŸ“£ Marketing & MÃ­dias"
          };
        ...
        {popularInRegion.length > 0 && (
          <CourseRow
            title="ðŸ“ Popular na sua RegiÃ£o"
