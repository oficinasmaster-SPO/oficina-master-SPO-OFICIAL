...
export default function Home() {
    ...
    const init = async () => {
      ...
      try {
        ...
        try {
          ...
          toast.error("Erro ao carregar dados do usuÃ¡rio: " + (userError.message || "Erro desconhecido"));
        ...
        if (error.message && !error.message.includes('unauthenticated')) {
            toast.error("Erro de autenticaÃ§Ã£o: " + error.message);
        }
        setIsAuthenticated(false);
        } finally {
        setIsCheckingAuth(false);
  ...
  const dashboardTips = [
    ...
    "FaÃ§a diagnÃ³sticos regulares para acompanhar a evoluÃ§Ã£o do seu negÃ³cio",
    "Use o mÃ³dulo de tarefas para organizar as aÃ§Ãµes recomendadas",
    "A gamificaÃ§Ã£o aumenta o engajamento da equipe em atÃ© 40%"
  ];
  ...
  // Landing page para usuÃ¡rios nÃ£o autenticados
  return (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center space-y-8">
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight">
              Descubra em que fase sua oficina estÃ¡ hoje
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Responda 12 perguntas rÃ¡pidas e receba um plano de aÃ§Ã£o personalizado para aumentar lucro, 
              organizaÃ§Ã£o e crescimento da sua oficina.
            </p>
            ...
            <p className="text-sm text-blue-100 mt-2">
              Comece grÃ¡tis e evolua conforme sua oficina cresce!
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="phases-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            As 4 Fases de EvoluÃ§Ã£o
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Entenda em qual estÃ¡gio sua oficina se encontra e o que precisa fazer para evoluir
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl mb-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Por que fazer o diagnÃ³stico?
          </h2>
          <p className="text-xl text-gray-600">
            Veja o que vocÃª vai receber gratuitamente
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="border-2 hover:shadow-xl transition-all">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">
                IdentificaÃ§Ã£o precisa da fase atual da sua oficina baseada em metodologia testada
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:shadow-xl transition-all">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Plano de AÃ§Ã£o com IA
              </h3>
              <p className="text-gray-600">
                RecomendaÃ§Ãµes personalizadas geradas por inteligÃªncia artificial para sua realidade
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:shadow-xl transition-all">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">
                Monitore sua evoluÃ§Ã£o ao longo do tempo com mÃºltiplos diagnÃ³sticos
              </p>
            </CardContent>
          </Card>
        </div>
