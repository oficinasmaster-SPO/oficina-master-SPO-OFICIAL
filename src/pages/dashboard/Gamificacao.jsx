...
export default function Gamificacao() {
  ...
  const { data: workshops = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        // OtimizaÃ§Ã£o: listar apenas o necessÃ¡rio ou usar cache melhor
  ...
  // Workshop do usuÃ¡rio atual ou do admin view
  ...
  const { data: nationalRankings = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return ranks.map((rank) => {
        ...
        return {
          ...rank,
          employee: emp || { full_name: 'UsuÃ¡rio Externo', profile_picture_url: null }, // Fallback
  ...
  const handleEditChallenge = (challenge) => {
    ...
    toast.info("EdiÃ§Ã£o de desafios em desenvolvimento");
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-3 flex items-center justify-center gap-3">Sistema de GameficaÃ§Ã£o
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-wrap gap-4 items-center">
                ...
                <div className="flex items-center gap-2">
                    <Select value={challengeTargetFilter} onValueChange={setChallengeTargetFilter}>
                        <SelectTrigger className="w-[160px]">
                            <SelectValue placeholder="ParticipaÃ§Ã£o" />
                        </SelectTrigger>
                        <SelectContent>
                ...
                <div className="flex items-center gap-2">
                    <Select value={challengeScopeFilter} onValueChange={setChallengeScopeFilter}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="global">NÃ­vel Brasil (Global)</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
                ...
                <div className="mb-4">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Baseado nos registros diÃ¡rios e engajamento</p>
                        </div>
                        <Button
                    variant="outline"
                    size="sm"
        ...
        {/* Modal de AtualizaÃ§Ã£o de Progresso */}
        <UpdateProgressModal
