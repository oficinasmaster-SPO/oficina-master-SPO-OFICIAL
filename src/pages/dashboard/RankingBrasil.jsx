...
export default function RankingBrasil() {
  ...
  const getMedalIcon = (position) => {
    ...
    return <span className="text-gray-600 font-bold">{position + 1}Âº</span>;
  };
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">
                          {emp.position} â€¢ {emp.workshopName}
                        </p>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Por mÃ©dia de produtividade</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  com maior percentual de produÃ§Ã£o sobre custos aparecem no topo do ranking nacional.
                </p>
              </div>
            </div>
          </CardContent>
