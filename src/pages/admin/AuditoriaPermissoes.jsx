...
export default function AuditoriaPermissoes() {
  ...
  const handleExport = () => {
    try {
      const csvContent = [
        ['Data/Hora', 'UsuÃ¡rio', 'AÃ§Ã£o', 'Campo', 'Valor Anterior', 'Novo Valor', 'Alterado Por', 'Email'].join(','),
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            HistÃ³rico completo de todas as alteraÃ§Ãµes de permissÃµes do sistema
          </p>
        </div>
