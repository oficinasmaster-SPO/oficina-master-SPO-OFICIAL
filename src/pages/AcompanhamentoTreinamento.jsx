      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
            ...
            <Button variant="outline" onClick={() => navigate(createPageUrl("GerenciarTreinamentos"))}>
                <ArrowLeft className="w-4 h-4 mr-2" /> Voltar para Gestão
            </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card>
                <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm text-slate-500">Aulas Concluídas (Total)</p>
                        <h3 className="text-2xl font-bold text-slate-900">
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-slate-500">{emp.position || "Cargo não definido"}</p>
                                            </div>
                                        </div>
                                    </TableCell>
                                    <TableCell>
                                                        ...
                                                        <TableRow key={lesson.id}>
                                                            ...
                                                            <TableCell>
                                                                {prog?.status === 'completed' ? (
                                                                    <Badge className="bg-green-100 text-green-700 hover:bg-green-100"><CheckCircle className="w-3 h-3 mr-1"/> Concluída</Badge>
                                                                ) : prog?.status === 'in_progress' ? (
                                                                    <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100">Em Andamento</Badge>
                                                                ) : (
                                                                    <span className="text-slate-400 text-sm">Não iniciada</span>
                                                                )}
                                                            </TableCell>
                                                            <TableCell className="text-sm text-slate-500">
