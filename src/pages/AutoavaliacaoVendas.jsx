...
export default function AutoavaliacaoVendas() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const aiPrompt = `
Analise a autoavaliação de Vendas de uma oficina automotiva com as seguintes notas (0-10):
...
1. Diagnóstico geral da área de vendas
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-3">
            Autoavaliação - Processos de Vendas
          </h1>
