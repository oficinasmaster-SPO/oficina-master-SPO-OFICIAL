    ...
    <div className={`min-h-screen bg-gray-900 text-white p-4 ${isFullScreen ? 'p-8' : ''}`}>
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">QGP - Quadro de GestÃ£o de PÃ¡tio</h1>
            <p className="text-blue-300 text-sm flex items-center gap-2">
              <Clock className="w-3 h-3" />
              {format(currentTime, "dd 'de' MMMM 'Ã s' HH:mm:ss", { locale: ptBR })}
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-4 overflow-x-auto">
        <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden shadow-2xl">
          <div className="grid grid-cols-12 gap-4 p-4 bg-gray-900/50 text-gray-400 font-medium text-sm uppercase tracking-wider border-b border-gray-700">
            ...
            <div className="col-span-2">VeÃ­culo</div>
            <div className="col-span-2">TÃ©cnico</div>
          ...
          <div className="divide-y divide-gray-700">
            ...
            {filteredTasks.length === 0 && (
              <div className="p-12 text-center text-gray-500">
                ...
                <p className="text-lg">Nenhum veÃ­culo no pÃ¡tio no momento.</p>
              </div>
            )}
          </div>
        </div>
