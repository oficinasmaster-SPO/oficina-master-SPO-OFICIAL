...
export default function DicasOperacao() {
  ...
  const handleSave = async () => {
    if (!workshop) {
      toast.error("Nenhuma oficina encontrada vinculada ao seu usuÃ¡rio");
      return;
    }
  ...
  if (!workshop && currentUser) {
    return (
      <div className="min-h-screen p-8 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Oficina nÃ£o encontrada</h2>
        <p className="text-gray-600 max-w-md">
          VocÃª precisa estar vinculado a uma oficina para gerenciar as dicas operacionais.
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Defina as mensagens e dicas rÃ¡pidas que aparecerÃ£o na tela inicial para toda a equipe
            </p>
          </div>
          <Button 
            onClick={handleSave} 
        ...
        <Card className="shadow-lg border-none">
          <CardHeader className="bg-white border-b">
            ...
            <CardDescription>
              Este texto serÃ¡ exibido com destaque na Dashboard de todos os colaboradores
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-100 flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-medium mb-1">SugestÃµes de uso:</p>
                <ul className="list-disc list-inside space-y-1 text-blue-700">
                  <li>Avisos sobre feriados ou horÃ¡rios especiais</li>
                  <li>Metas da semana ou do mÃªs</li>
                  <li>Lembretes sobre procedimentos de seguranÃ§a</li>
        ...
        {/* Preview */}
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">PrÃ©-visualizaÃ§Ã£o</h3>
          <Card className="bg-gradient-to-r from-indigo-50 to-blue-50 border-l-4 border-indigo-500 shadow-sm">
            <CardContent className="p-4 flex gap-3">
              ...
              <div>
                <h3 className="font-bold text-indigo-900 text-lg mb-1">Dicas RÃ¡pidas</h3>
