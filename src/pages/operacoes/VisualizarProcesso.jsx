  ...
  if (!doc) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        <h1 className="text-xl font-semibold">Processo nÃ£o encontrado</h1>
      ...
      <div className="max-w-6xl mx-auto print:max-w-full">
        <div className="flex justify-between items-center mb-6 print:hidden">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => setVersionDialogOpen(true)}>
              <GitBranch className="w-4 h-4 mr-2" /> VersÃµes
            </Button>
            {doc.pdf_url && (
        ...
        <Tabs defaultValue="conteudo" className="mb-6 print:hidden">
          <TabsList className="grid w-full grid-cols-5">
            <TabsTrigger value="conteudo">ConteÃºdo MAP</TabsTrigger>
            <TabsTrigger value="its">ITs & FRs</TabsTrigger>
            <TabsTrigger value="implementacao">ImplementaÃ§Ã£o</TabsTrigger>
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200 print:shadow-none print:border-0">
          ...
          <div className="border-b-2 border-gray-800 p-6 flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 uppercase">Mapa da Auto GestÃ£o do Processo</h1>
                <h2 className="text-lg text-gray-600">{doc.title}</h2>
              </div>
            </div>
            <div className="text-right text-sm text-gray-600">
              <p><strong>CÃ³digo:</strong> {doc.code || "N/A"}</p>
              <p><strong>VersÃ£o:</strong> {doc.revision || "1"}</p>
          ...
          <div className="p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">
                {content.objetivo || "NÃ£o definido."}
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">
                {content.campo_aplicacao || "NÃ£o definido."}
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">
                {content.informacoes_complementares || "NÃ£o definido."}
              </p>
            </section>
            ...
            {/* PDF Embed (Fallback se nÃ£o houver conteÃºdo estruturado mas houver PDF) */}
              ...
              <section className="break-inside-avoid mt-8">
                ...
                <div className="border rounded-lg overflow-hidden h-[800px] bg-gray-100">
                  <iframe 
                    ...
                    title="PDF Viewer"
                  >
                    <p>Seu navegador nÃ£o suporta visualizaÃ§Ã£o de PDF. <a href={doc.pdf_url}>Clique para baixar.</a></p>
                  </iframe>
                </div>
              </section>
            )}
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-100">
                      ...
                      <TableHead className="font-bold text-gray-900">ResponsÃ¡vel</TableHead>
            ...
            <section className="break-inside-avoid">
              ...
              {content.matriz_riscos && content.matriz_riscos.length > 0 ? (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-100">
                      <TableHead className="font-bold text-gray-900">IdentificaÃ§Ã£o</TableHead>
                  ...
                  <TableBody>
                    {content.matriz_riscos.map((item, idx) => (
                      <TableRow key={idx}>
                        ...
                        <TableCell>
                          <Badge variant={item.categoria === 'Alto' ? 'destructive' : item.categoria === 'MÃ©dio' ? 'secondary' : 'outline'}>
                            {item.categoria}
                          </Badge>
                        </TableCell>
            ...
            <section className="break-inside-avoid">
              <h3 className="text-lg font-bold text-gray-900 border-b pb-2 mb-3 uppercase flex items-center gap-2">
                7. Inter-relaÃ§Ã£o entre Ãreas
              </h3>
              {content.inter_relacoes && content.inter_relacoes.length > 0 ? (
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-100">
                      <TableHead className="w-[30%] font-bold text-gray-900">Ãrea</TableHead>
                      <TableHead className="font-bold text-gray-900">InteraÃ§Ã£o (Entrada/SaÃ­da)</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                ...
                <p className="text-gray-500 italic">Nenhuma inter-relaÃ§Ã£o mapeada.</p>
              )}
            </section>
        ...
        <VersionHistoryDialog
          ...
          onAddVersion={(versionData) => {
            ...
            // Redirecionar para ediÃ§Ã£o com nova versÃ£o
