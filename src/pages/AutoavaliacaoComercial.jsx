...
import { Loader2, Phone, Sparkles, AlertCircle } from "lucide-react";
...
export default function AutoavaliacaoComercial() {
  ...
  const criteria = assessmentCriteria.comercial;
  ...
  const loadData = async () => {
    try {
      ...
      base44.auth.redirectToLogin(createPageUrl("AutoavaliacaoComercial"));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const aiPrompt = `
Analise a autoavaliação Comercial de uma oficina automotiva com as seguintes notas (0-10):
...
1. Diagnóstico geral da área comercial
...
6. Ações imediatas (próximos 7 dias)
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-3">
            Autoavaliação - Processos Comerciais
          </h1>
