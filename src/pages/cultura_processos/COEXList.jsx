...
export default function COEXList() {
  ...
  const tourSteps = [
    {
      target: "coex-stats",
      title: "EstatÃ­sticas COEX",
      description: "Veja quantos contratos estÃ£o ativos e quantos precisam renovaÃ§Ã£o.",
      position: "bottom"
    },
    {
      target: "coex-search",
    ...
    },
    {
      ...
      description: "Clique no botÃ£o para criar um novo contrato ou visualizar/renovar um existente.",
      position: "top"
    }
  ];
  ...
  const helpContent = {
    ...
    description: "O COEX Ã© um acordo formal que alinha expectativas entre gestor e colaborador. Define metas, entregas, comportamentos esperados e estabelece compromisso mÃºtuo.",
    faqs: [
      {
        question: "O que Ã© o COEX?",
        answer: "COEX Ã© o Contrato de Expectativa. Um documento que alinha o que o gestor espera do colaborador e vice-versa."
      },
      {
        question: "Tem validade jurÃ­dica?",
        answer: "NÃ£o. O COEX tem validade emocional. Ele cria compromisso e clareza, elevando o salÃ¡rio emocional da equipe."
      },
      {
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Alinhe expectativas, metas e comportamentos com sua equipe atravÃ©s de acordos formais
              </p>
            </div>
          </div>
        </div>
