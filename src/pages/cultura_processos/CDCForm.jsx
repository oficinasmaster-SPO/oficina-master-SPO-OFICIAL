...
export default function CDCForm() {
  ...
  const saveMutation = useMutation({
    mutationFn: async (data) => {
      // Salvar como histÃ³rico em CDCRecord
      ...
      // Atualizar flag no funcionÃ¡rio apenas para facilitar listagem rÃ¡pida
      await base44.entities.Employee.update(employeeId, {
        cdc_completed: true,
        cdc_data: data // Mantemos o Ãºltimo para referÃªncia rÃ¡pida se necessÃ¡rio
      });
  ...
  const handleExportPDF = () => {
    if (!workshop) {
      toast.error("Dados da oficina nÃ£o carregados para impressÃ£o.");
      return;
    }
    ...
    printWindow.document.write(`
      ...
      <body>
        <div class="header">
          ...
          <h1 style="margin-top: 20px; font-size: 22px;">CDC - ConexÃ£o e DiagnÃ³stico do Colaborador</h1>
        ...
        <div class="field">
          <label>Expectativa do colaborador em relaÃ§Ã£o ao futuro da empresa:</label>
        ...
        <div class="field">
          <label>Melhor canal de comunicaÃ§Ã£o:</label>
  ...
  const tourSteps = [
    {
      ...
      description: "Comece preenchendo dados pessoais do colaborador: nome, aniversÃ¡rio, filhos, sonhos e hobbies.",
      position: "bottom"
    },
    {
      target: "cdc-expectations",
      title: "Expectativas e Desenvolvimento",
      description: "Registre as expectativas do colaborador sobre a empresa, pontos fortes e Ã¡reas a desenvolver.",
      position: "bottom"
    },
    {
      target: "cdc-profile",
      title: "Perfil Comportamental",
      description: "Adicione o perfil DISC, valores e melhor canal de comunicaÃ§Ã£o para gestÃ£o personalizada.",
      position: "top"
    },
    {
      target: "cdc-actions",
      title: "Salvar e Exportar",
      description: "Salve as informaÃ§Ãµes e exporte em PDF para manter no arquivo do colaborador.",
      position: "top"
    }
  ];
  ...
  const helpContent = {
    ...
    description: "O CDC Ã© uma ferramenta poderosa para criar conexÃ£o genuÃ­na com seu colaborador. Use essas informaÃ§Ãµes para gestÃ£o personalizada, conversas difÃ­ceis e aumentar o salÃ¡rio emocional da equipe.",
    faqs: [
      {
        question: "Por que fazer o CDC?",
        answer: "O CDC ajuda vocÃª a conhecer profundamente cada colaborador, criar conexÃ£o e usar essas informaÃ§Ãµes estrategicamente em feedbacks e alinhamentos."
      },
      {
        question: "Como usar as informaÃ§Ãµes do CDC?",
        answer: "Use em conversas difÃ­ceis, para lembrar nomes de familiares, alinhar expectativas e demonstrar que vocÃª se importa com a pessoa."
      },
      {
        question: "O que Ã© salÃ¡rio emocional?",
        answer: "Ã‰ o investimento emocional que vocÃª faz no colaborador. Quanto mais alto, mais vocÃª pode cobrar sem que ele saia da empresa."
      },
      {
        question: "Quando aplicar o CDC?",
        answer: "Pode ser aplicado em uma reuniÃ£o 1:1 especial ou durante a integraÃ§Ã£o de um novo colaborador."
      }
    ]
  };
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Ex: JoÃ£o - 5 anos, Maria - 8 anos"
                  rows={2}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Ex: Ter minha prÃ³pria oficina, viajar pelo mundo..."
                    rows={3}
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Principais forÃ§as"
                    rows={4}
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Ãreas de melhoria"
                    rows={4}
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="CompetÃªncias tÃ©cnicas"
                    rows={4}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: Honestidade, FamÃ­lia..."
                  />
                </div>
              </div>
            </CardContent>
