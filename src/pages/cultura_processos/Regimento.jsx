  ...
  const handleCreateNew = async () => {
    try {
      ...
      if (response.data.success) {
        toast.success("Modelo padrÃ£o criado!");
        refetch();
      }
    } catch (error) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Documento jurÃ­dico e operacional que define direitos, deveres e normas de conduta
                </p>
              </div>
            </div>
        ...
        <Card>
          <CardContent className="py-16 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Crie o primeiro regimento interno da sua empresa para estabelecer normas claras e proteger juridicamente a organizaÃ§Ã£o.
            </p>
            <Button onClick={handleCreateNew} className="bg-blue-600 hover:bg-blue-700">
              <Plus className="w-4 h-4 mr-2" />
                ...
                <CardContent className="p-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge className="bg-green-100 text-green-800">VersÃ£o {activeRegiment.version}</Badge>
                        ...
                        {activeRegiment.published_at && (
                          <p className="text-xs text-gray-500 mt-1">
                            Publicado em {format(new Date(activeRegiment.published_at), "dd/MM/yyyy 'Ã s' HH:mm")}
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-900">
                      <strong>Objetivo:</strong> {activeRegiment.objective || 'NÃ£o definido'}
                    </p>
                  </div>
                </CardContent>
              </Card>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <Badge variant="outline">VersÃ£o {regiment.version}</Badge>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">
                              Vigente atÃ©: {regiment.effective_date ? format(new Date(regiment.effective_date), 'dd/MM/yyyy') : '-'}
                            </p>
                          </div>
                        </div>
                        <Button variant="outline" size="sm" onClick={() => handleView(regiment)}>
