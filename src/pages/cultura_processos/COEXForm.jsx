...
export default function COEXForm() {
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      try {
        ...
        toast.error("Erro ao carregar dados do usuÃ¡rio ou oficina.");
      }
    };
    loadInitialData();
  ...
  const saveMutation = useMutation({
    mutationFn: async (data) => {
      ...
      // Atualizar o funcionÃ¡rio para marcar o COEX como completo
      if (employeeId) {
  ...
  const handleExportPDF = () => {
    if (!workshop || !user) {
      toast.error("Dados da oficina ou usuÃ¡rio nÃ£o carregados para impressÃ£o.");
      return;
    }
    ...
    printWindow.document.write(`
      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .item:before { content: "â€¢"; position: absolute; left: 0; color: #E31837; }
      ...
      <body>
        <div class="header">
          ...
          <div class="slogan">Oficinas Master EducaÃ§Ã£o Empresarial</div>
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <div>InÃ­cio: ${formData.start_date || '-'}<br>Fim: ${formData.end_date || '-'}</div>
          </div>
        </div>
        
        <div class="columns">
          <div class="column">
            <div class="column-header">EntregÃ¡veis/Metas</div>
        ...
        <div class="footer-text">
          ...
          qualidade em nossos serviÃ§os prestados, e para que possamos buscar constantemente o desenvolvimento alcanÃ§ando 
        ...
        <div style="margin-bottom: 10px;">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <strong>Data do prÃ³ximo alinhamento:</strong> ${formData.next_alignment_date ? new Date(formData.next_alignment_date).toLocaleDateString('pt-BR') : '-'}
        </div>
  ...
  const tourSteps = [
    {
      ...
      description: "O COEX Ã© um acordo formal entre gestor e colaborador que alinha expectativas, metas e comportamentos esperados.",
      position: "bottom"
    },
    {
      target: "coex-deliverables",
      title: "EntregÃ¡veis e Metas",
      description: "Liste as entregas esperadas: quantos carros atendidos, ticket mÃ©dio, rentabilidade, etc.",
      position: "bottom"
    },
    {
      target: "coex-behaviors",
      title: "Comportamentos e Atitudes",
      description: "Defina valores e comportamentos inegociÃ¡veis que o colaborador deve demonstrar.",
      position: "bottom"
    },
    {
      target: "coex-actions",
  ...
  const helpContent = {
    ...
    description: "O COEX Ã© uma ferramenta de gestÃ£o que cria compromissos emocionais entre gestor e colaborador. NÃ£o tem validade jurÃ­dica, mas eleva o salÃ¡rio emocional e reduz turnover.",
    faqs: [
      {
        question: "O COEX tem validade jurÃ­dica?",
        answer: "NÃ£o. O COEX tem validade emocional. Ele cria compromisso e clareza sobre o que ambos esperam um do outro."
      },
      {
        question: "Como definir metas?",
        answer: "Seja especÃ­fico: nÃºmero de carros atendidos, ticket mÃ©dio, rentabilidade R70/I30, retorno, qualidade. Use dados reais."
      },
      {
        question: "Como definir comportamentos?",
        answer: "Liste valores inegociÃ¡veis: pontualidade, proatividade, trabalho em equipe, alinhamento com missÃ£o e valores da empresa."
      },
      {
        ...
        {coexRestriction.restricted && (
          <div className="mb-6 bg-orange-50 border-l-4 border-orange-500 p-4">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-orange-800 font-bold">CriaÃ§Ã£o de COEX Restrita</h3>
                <p className="text-orange-700 text-sm mt-1">
                  Este colaborador jÃ¡ possui um COEX recente. Um novo contrato sÃ³ poderÃ¡ ser criado a partir de <strong>{format(coexRestriction.nextDate, 'dd/MM/yyyy')}</strong> (6 meses apÃ³s o anterior).
                </p>
            ...
            <Card id="coex-deliverables" className="border-2 border-red-200">
              <CardHeader className="bg-red-50">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-red-900">EntregÃ¡veis/Metas</CardTitle>
                ...
                {formData.deliverables_goals.map((item, index) => (
                  <div key={index} className="flex gap-2">
                    <Textarea
                      ...
                      placeholder="Ex: Manter material organizado, 15 carros/mÃªs..."
                      rows={2}
                      className="flex-1"
                    />
            ...
            <CardContent className="pt-6">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-4">
                <p className="text-sm text-gray-700 leading-relaxed">
                  ...
                  responsabilidade a fim de mantermos a qualidade em nossos serviÃ§os prestados, e para que possamos 
                  buscar constantemente o desenvolvimento alcanÃ§ando novos desafios e novas metas.
                </p>
              </div>

              <div>
                <Label>Data do prÃ³ximo alinhamento</Label>
                <Input
                  type="date"
