...
export default function CDCList() {
  ...
  const tourSteps = [
    {
      target: "cdc-stats",
      title: "Estatísticas CDC",
      description: "Veja quantos CDCs foram completados e quantos ainda estão pendentes.",
      position: "bottom"
    },
    {
      target: "cdc-search",
    ...
    },
    {
      ...
      description: "Clique no botão para aplicar um novo CDC ou editar um existente.",
      position: "top"
    }
  ];
  ...
  const helpContent = {
    ...
    description: "O CDC é uma ferramenta para criar conexão genuína com seus colaboradores. Registre informações pessoais, sonhos, expectativas e perfil comportamental para gestão personalizada.",
    faqs: [
      {
        question: "O que é o CDC?",
        answer: "CDC significa Conexão e Diagnóstico do Colaborador. É uma entrevista estruturada para conhecer profundamente cada membro da equipe."
      },
      {
        question: "Quando aplicar o CDC?",
        answer: "Ideal aplicar no onboarding de novos colaboradores ou em reuniões 1:1 especiais. Leva cerca de 15-30 minutos."
      },
      {
        question: "Como usar as informações?",
        answer: "Use para personalizar feedbacks, lembrar datas importantes, alinhar expectativas e demonstrar que você se importa com a pessoa."
      }
    ]
  };
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Crie conexão genuína com sua equipe através do conhecimento profundo de cada colaborador
              </p>
            </div>
          </div>
        </div>
