...
export default function CadastroColaborador() {
  ...
  // ... formData state ... (lines 23-53 mapped in original, skipping here for brevity in logic but need to be careful with replace)
  // To avoid replacing huge block, I will just replace the import and the start of component
