...
export default function AutoavaliacaoPessoas() {
  ...
  const loadData = async () => {
    try {
      ...
      base44.auth.redirectToLogin(createPageUrl("AutoavaliacaoPessoas"));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-3">
            Autoavaliação - Processos de Pessoas (RH)
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center">
            <Button
              type="submit"
              disabled={submitting}
              className="bg-purple-600 hover:bg-purple-700 text-lg px-12 py-6"
            >
              {submitting ? (
                <>
