      ...
      <div className="flex h-screen items-center justify-center p-4">
        <Card className="w-full max-w-md text-center">
          <CardContent className="pt-6">
            <p className="text-gray-500">Ritual não encontrado ou link inválido.</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="flex h-screen items-center justify-center p-4 bg-green-50">
        <Card className="w-full max-w-md text-center border-green-200 shadow-lg">
          <CardContent className="pt-10 pb-10">
            ...
            <p className="text-green-700">Sua evidência foi registrada com sucesso.</p>
          </CardContent>
        </Card>
      </div>
    );
        ...
        <CardContent className="p-6">
          <div className="text-center space-y-6">
            <p className="text-gray-600">
              Por favor, envie uma foto ou documento que comprove a realização deste ritual.
            </p>
