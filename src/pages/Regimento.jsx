  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <Dialog open={showEditor} onOpenChange={(open) => {
        ...
        <DialogContent className="w-[96vw] max-w-[1600px] h-[92vh] p-0 overflow-hidden !flex !flex-col !gap-0" hideClose>
      ...
      <Dialog open={showViewer} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] p-0 overflow-y-auto regiment-print-viewer">
          {selectedRegiment && (
            <RegimentViewer
              regiment={selectedRegiment}
              onClose={() => {
