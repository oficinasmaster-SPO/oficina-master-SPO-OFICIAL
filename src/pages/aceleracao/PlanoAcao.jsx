...
export default function PlanoAcao() {
  ...
  const planoAcaoTips = [
    "Organize as aÃ§Ãµes por prioridade e defina prazos realistas",
    "Atribua responsÃ¡veis para garantir que as aÃ§Ãµes sejam executadas",
    "Use subtarefas para quebrar aÃ§Ãµes complexas em etapas menores",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="ai-suggestions" className="space-y-6">
          <TabsList className="bg-white shadow-md p-1">
            ...
            <TabsTrigger value="actions">AÃ§Ãµes Detalhadas</TabsTrigger>
          </TabsList>
        ...
        {/* PDF Preview (hidden, sÃ³ para impressÃ£o) */}
        {showPDF && (
          <EnhancedPDFPreview
            diagnostic={diagnostic}
            workshop={workshop}
