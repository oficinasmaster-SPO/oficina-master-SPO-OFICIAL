...
export default function PedidoInternoModal({ open, onClose, children, size = "default" }) {
  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => !nextOpen && onClose()}>
      <DialogContent hideClose onOpenAutoFocus={(e) => e.preventDefault()} className={`flex w-[calc(100vw-1rem)] ${sizeClass} flex-col gap-0 overflow-hidden rounded-2xl p-0 sm:w-[calc(100vw-2rem)]`}>
