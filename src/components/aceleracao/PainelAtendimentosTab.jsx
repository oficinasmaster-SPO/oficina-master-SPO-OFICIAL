...
import { Edit, AlertTriangle, FilePlus, Play, StopCircle, CalendarClock, FileText, CheckCircle, Trash2, Clock, Search, X, CalendarDays, Filter, MoreVertical, SearchX, PlusCircle, Building2 } from "lucide-react";
...
export default function PainelAtendimentosTab({ state }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Drawer de detalhes com validação */}
      <AttendanceDetailsDrawer
        open={detailsDrawer.open}
        onOpenChange={(open) => setDetailsDrawer(prev => ({ ...prev, open }))}
        attendanceItem={detailsDrawer.item}
        validation={detailsDrawer.validation}
      />
    </div>
  );
}