  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-1 flex h-1.5 w-full overflow-hidden rounded-full bg-gray-200">
        ...
        {activePercent > 0 && (
          <div className="bg-blue-500 transition-all duration-300" style={{ width: `${activePercent}%` }} />
        )}
        {futurePercent > 0 && (
          <div className="bg-gray-200 transition-all duration-300" style={{ width: `${futurePercent}%` }} />
        )}
      </div>
    </div>
  );
