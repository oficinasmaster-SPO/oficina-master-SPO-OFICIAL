...
const FollowUpQueue = memo(({ reminders = [], today, onSelectReminder }) => {
  ...
  return (
    <div className="flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden h-full min-h-0">
      {/* Header da fila */}
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-200 bg-gray-50 flex-shrink-0">
        <h2 className="text-sm font-bold text-gray-700">Fila de Follow-ups</h2>
        <span className="text-xs text-gray-400">{reminders.length} no total</span>
      </div>
