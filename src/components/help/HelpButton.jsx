  ...
  return (
    <>
      <Button
        ...
        className="fixed top-20 right-6 z-40 bg-blue-600 hover:bg-blue-700 text-white shadow-lg rounded-full w-12 h-12"
        title="Ajuda"
      >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Espaço para vídeo (quando não fornecido) */}
            {!videoUrl && (
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-lg font-semibold text-gray-900">
                ...
                <div className="relative w-full aspect-video bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p>Vídeo será disponibilizado em breve</p>
                  </div>
                </div>
              </div>
            )}
