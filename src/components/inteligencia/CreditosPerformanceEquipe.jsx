...
export default function CreditosPerformanceEquipe({ data }) {
  ...
  const equipes = [
    {
      nome: "Marketing",
      credito: data.creditoMarketing || 0,
      pessoas: data.pessoasMarketing || 0,
      percentual: data.percentualMarketing || 0,
    ...
    {
      nome: "Comercial/SDR",
      credito: data.creditoComercial || 0,
      pessoas: data.pessoasComercial || 0,
      percentual: data.percentualComercial || 0,
    ...
    {
      nome: "Vendas",
      credito: data.creditoVendas || 0,
      pessoas: data.pessoasVendas || 0,
      percentual: data.percentualVendas || 0,
      bgColor: "bg-blue-50",
    ...
    {
      nome: "Técnico",
      credito: data.creditoTecnico || 0,
      pessoas: data.pessoasTecnico || 0,
      percentual: data.percentualTecnico || 0,
      bgColor: "bg-teal-50",
