...
/**
 * Conteúdo do Resultado DISC — compartilhado entre o modal (HistoricoDISC)
 * e a página de rota (/ResultadoDISC?id=).
 */
export default function ResultadoDISCContent({ diagnostic, employee, teamComparison, onClose }) {
  ...
  return (
    <div className="bg-white">
      <div className="bg-white border-b shadow-md" style={{ boxShadow: '0 5px 10px rgba(0,0,0,0.1)' }}>
