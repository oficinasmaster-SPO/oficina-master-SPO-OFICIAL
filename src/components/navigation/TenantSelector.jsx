          ...
          <PopoverContent className="w-[220px] p-0 bg-white" align="start">
            <Command className="bg-white">
              ...
              <div className="relative">
                {/* Scroll up zone */}
                <div className="bg-gradient-to-b mx-8 px-12 opacity-0 absolute top-0 left-0 right-0 h-7 z-10 flex items-center justify-center hover:opacity-100 transition-all duration-200 from-white via-white/80 to-transparent cursor-pointer group"
