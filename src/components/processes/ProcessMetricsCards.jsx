...
import { FileText, ClipboardList, CheckCircle, FileCheck, Building2, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
      {metrics.map((metric, index) => {
        ...
        return (
          <Card key={index} className={`${metric.color} border-2 hover:shadow-lg transition-all duration-200`}>
