...
export default function ImpersonationBanner() {
  ...
  const { target_user, admin, started_at } = data;
  ...
  return (
    <>
      <style>{`
        ...
        .imp-shine {
          animation: imp-shine 5s ease-in-out infinite;
        }
        .imp-exit-btn {
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 4px 16px -4px rgba(194,65,12,0.5), inset 0 1px 0 rgba(255,255,255,0.15)',
          zIndex: 60,
          width: '100vw',
          position: 'relative',
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'repeating-linear-gradient(45deg, rgba(0,0,0,0.04) 0, rgba(0,0,0,0.04) 1px, transparent 1px, transparent 10px)',
          }}
        />
        {/* Shine */}
        <div
          aria-hidden="true"
          className="absolute inset-0 pointer-events-none imp-shine"
          style={{
        ...
        <div className="relative flex items-center justify-between px-4 sm:px-5 py-2" style={{ gap: '12px', minHeight: '48px' }}>
          {/* Left: ícone + label */}
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.12em', color: '#fff', textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>
              Modo Impersonação
            </span>
          </div>

          {/* Middle: dados do usuário */}
          <div className="flex items-center gap-3 min-w-0 flex-1 flex-wrap">
            ...
            {/* Email */}
            <span className="hidden sm:block" style={{ fontSize: '12px', color: 'rgba(255,255,255,0.9)', whiteSpace: 'nowrap' }}>
              {target_user.email}
            </span>
