export const questions = [
  {
    ...
    options: [
      ...
      { letter: "C", text: "Está consolidada no mercado e pode focar e pensar em um planejamento a longo prazo." },
      { letter: "D", text: "Precisa trabalhar focada em gerar lucro para consolidar o negócio." }
    ]
  },
  {
    id: 2,
    ...
    options: [
      ...
      { letter: "C", text: "Tem um bom quadro de funcionários mas enfrenta conflitos frequentes e falta de organização." },
      { letter: "D", text: "Tem a mão de obra bem reduzida para dar conta do trabalho, todos (ou a maioria) acumulam várias funções para produzir resultado." }
    ]
  },
  {
    id: 3,
    ...
    options: [
      ...
      { letter: "C", text: "A gestão está focada em controlar gastos e gerar mais lucros." },
      { letter: "D", text: "Está focada em acompanhar o planejamento estratégico." }
    ]
  },
  {
    id: 4,
    ...
    options: [
      ...
      { letter: "C", text: "A empresa já tem um bom time e se faz necessário a liderança até para controlar os processos." },
      { letter: "D", text: "Com o aumento da equipe percebe-se a necessidade de começar a estabelecer e trabalhar liderança." }
    ]
  },
  {
    id: 5,
    ...
    options: [
      ...
      { letter: "C", text: "Já estamos com o time formado e precisamos organizar as atividades, estabelecendo a melhor maneira de realizá-las, de acordo com a necessidade do negócio." },
      { letter: "D", text: "Os processos são mais focados em vender e controlar custos pois ainda não temos saúde financeira." }
    ]
  },
  {
    id: 6,
    ...
    options: [
      ...
      { letter: "C", text: "Já temos um bom lucro e um time, mas estamos com reclamações de clientes e conflitos internos." },
      { letter: "D", text: "Precisamos gerar lucro para continuar com a empresa e atingirmos mais lucratividade." }
    ]
  },
  {
    id: 7,
    ...
    options: [
      ...
      { letter: "C", text: "Já temos bons talentos dentro da empresa mais ainda temos muitos conflitos internos." },
      { letter: "D", text: "Nosso time é engajado e funciona bem mesmo na ausência dos gestores." }
    ]
  },
  {
    id: 8,
    ...
    options: [
      ...
      { letter: "C", text: "Já sinto uma grande necessidade de dividir as atividades e delegar algumas tarefas." },
      { letter: "D", text: "No momento tenho que ficar atento a tudo que acontece e exercer diversas funções." }
    ]
  },
  {
    id: 9,
    ...
    options: [
      ...
      { letter: "C", text: "Para atender a demanda que temos no momento se percebe que precisamos aumentar a equipe." },
      { letter: "D", text: "Estamos focados em buscar mais clientes e entregar o que vendemos." }
    ]
  },
  {
    id: 10,
    ...
    options: [
      ...
      { letter: "C", text: "Já temos um bom quadro de funcionários, que desempenham suas funções mais ainda com grande necessidade de intervenção da gerencia." },
      { letter: "D", text: "Os funcionários já se mostram independentes e os lideres já tem poder decisório." }
    ]
  },
  {
    id: 11,
    ...
    options: [
      ...
      { letter: "C", text: "Focar no planejamento estratégico para que a empresa cresça mais." },
      { letter: "D", text: "De diminuir o número de conflitos e reclamações." }
    ]
  },
  {
    id: 12,
    ...
    options: [
      ...
      { letter: "C", text: "Não temos uma cultura estabelecida, ainda não temos um jeito de trabalhar, resolvemos os problemas conforme aparecem." },
      { letter: "D", text: "A missão, visão e valores da empresa já são bem claros para todos." }
    ]
  }
];