...
import { LogOut, Menu, X, LogIn, AlertCircle } from "lucide-react";
  ...
  return (
    <OnboardingGate user={displayUser} isAuthenticated={isAuthenticated}>
      ...
      {isAuthenticated && displayUser && <AssistanceModeBanner user={displayUser} />}
          ...
          <div className="h-16 sm:px-6 lg:px-8 px-4 py-1">
                  ...
                  {isCheckingAuth ?
                    ...
                    <>
                      <div className="hidden md:block text-right">
                        ...
                        workshop ?
                        // Fase C: seleção de oficina é feita exclusivamente pelo
                        // TenantSelector (canônico, memberships-scoped, com opção
                        // "Minha oficina (matriz)"). Este bloco é apenas display
                        // — evita o segundo seletor duplicado que existia aqui.
                        <>
                            <p className="text-sm font-medium text-gray-900">
                              {workshop.name}
                            </p>
