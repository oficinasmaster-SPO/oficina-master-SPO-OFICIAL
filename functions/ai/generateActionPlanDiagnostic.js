...
${hasJustifications ? `
**IMPORTANTE:** Use acima para personalizar o plano. Cite explicitamente o que o cliente relatou.
...
3. Direcionamentos por área (4-6 áreas prioritárias, processos, pessoas, financeiro, etc)
4. Timeline de ações:
