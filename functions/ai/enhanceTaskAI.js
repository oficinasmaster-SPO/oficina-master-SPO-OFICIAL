...
Deno.serve(async (req) => {
    try {
        ...
        1. EPIs Recomendados equipamentos de proteção individual são necessários? (Se aplicável, senão "Não se aplica")
        2. Especificidade técnicos ou específicos de como a tarefa deve ser feita para evitar erros. Seja direto e claro.
        3. Passo a Passo ordenada de ações para executar a tarefa.
        4. Indicador de Sucesso saber se a tarefa foi concluída com êxito? (Critério de aceitação)
        5. Prazo Sugerido estimativa de tempo ou prazo razoável para essa tarefa (em texto, ex: "2 horas", "1 dia").
