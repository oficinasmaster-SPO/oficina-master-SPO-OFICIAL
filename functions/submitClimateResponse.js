...
Deno.serve(async (req) => {
  try {
    ...
    // Use service role to update entity is a public endpoint
    ...
    // Add new response
    const newResponse = {
        response_id.random().toString(36).substr(2, 9),
    ...
    await base44.asServiceRole.entities.CompanyClimate.update(survey_id, {
        ...
        dimensions,
        overall_score,
        participation_rate.length // Just count for now, percentage requires total employees
    });
