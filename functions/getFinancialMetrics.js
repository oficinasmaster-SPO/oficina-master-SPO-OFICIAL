  ...
  try {
    ...
    filteredContracts.forEach(contract => {
      ...
      if (contract.payment_confirmed) {
        ...
        const dueDate = contract.payment_due_date ? new Date(contract.payment_due_date) ;
    ...
    return Response.json({
      ...
      totalOverdue,
      conversionRate,
      planPerformance.values(planPerformance),
      consultorPerformance.values(consultorPerformance),
      contracts
    });
